...
/**
 * The configuration screen for the {@link BirthdayWidget BirthdayWidget} AppWidget.
 */
public class BirthdayWidgetConfigureActivity extends Activity {

    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    EditText mAppWidgetText;
    private static final String PREFS_NAME = "com.example.vkirillov.screenwidget.BirthdayWidget";
