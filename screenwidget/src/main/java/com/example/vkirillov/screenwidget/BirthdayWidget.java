 ...
 * App Widget Configuration implemented in {@link BirthdayWidgetConfigureActivity BirthdayWidgetConfigureActivity}
 */
public class BirthdayWidget extends AppWidgetProvider {
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        final int N = appWidgetIds.length;
        for (int i = 0; i < N; i++) {
            BirthdayWidgetConfigureActivity.deleteTitlePref(context, appWidgetIds[i]);
        }
    }
